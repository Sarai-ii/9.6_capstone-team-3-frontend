    ...
    <div className='pg-footer'>
      <footer className='footer'>
        ...
        <div className='footer-content'>
          ...
          <div className="footer-content-column">
            <div id="footer-button-container" className="footer-call-to-action">
              {!user ? (
                ...
                // if someone is logged in, show Events button
                <Link to="/events" id="footer-main-events-link" className="button call-to-action-events-link"> Events </Link>
              )}
            </div>
          </div>
        </div>
